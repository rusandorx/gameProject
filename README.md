...
Предметы редко выпадают, но они компенсируют это тем, что на их использование не тратится текущий ход. <br>
Если герой был повержен то его уровень сбрасывается. <br>
На "Enter" открывается меню, в котором можно применить лечащую магию.
